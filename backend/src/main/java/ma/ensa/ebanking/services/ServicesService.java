...
import ma.ensa.ebanking.request.*;
...
public class ServicesService {
    ...
    public List<ServiceDTO> findServiceByIdOrNameAndType(String keyword, ServiceType type){
        return serviceRepository.findServiceByIdOrNameAndType(keyword, type);
    }
}
